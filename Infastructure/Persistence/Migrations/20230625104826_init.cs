    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MainSales", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MainSales_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    SaleMainId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SaleDetails_MainSales_SaleMainId",
                        column: x => x.SaleMainId,
                        principalTable: "MainSales",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SaleDetails_Variants_VariantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleDetails_SaleMainId",
                table: "SaleDetails",
                column: "SaleMainId");

            migrationBuilder.CreateIndex(
                name: "IX_SaleDetails_VariantId",
                table: "SaleDetails",
                column: "VariantId");
